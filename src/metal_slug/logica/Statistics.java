...
public class Statistics
  {
    ...
    public Statistics()
      {
        ...
        this.imgNumGranate = new Image[Statistics.NUM_GRANATE];
    ...
    private void loadImageNumGranate()
      {
        this.imgNumGranate[0] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/0.png");
        this.imgNumGranate[1] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/1.png");
        this.imgNumGranate[2] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/2.png");
        this.imgNumGranate[3] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/3.png");
        this.imgNumGranate[4] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/4.png");
        this.imgNumGranate[5] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/5.png");
        this.imgNumGranate[6] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/6.png");
        this.imgNumGranate[7] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/7.png");
        this.imgNumGranate[8] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/8.png");
        this.imgNumGranate[9] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/9.png");
        this.imgNumGranate[10] = Resource.getImage("/metal_slug/media/images/Panels/GamePanel/Numero_granate/10.png");
      }
